...
layui.define('view', function(exports){
    ...
    var events = admin.events = {
        ...
        //打开新窗口页面
        ,openWindow: function(){
          var iframe1 = admin.tabsBody(admin.tabsPage.index).find('.layadmin-iframe');
          var iframe2 = iframe1.contents().find('.layui-layer-iframe').find('iframe');
          var src = iframe2.length > 0 ? iframe2[0].src : iframe1[0].src;
          window.open(src);
        }
        //刷新
        ,refresh: function(){
